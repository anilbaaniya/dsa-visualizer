...
export default function PrefixTheory() {
  return (
    <div className="bg-white w-200 rounded-2xl px-8 py-10 flex flex-col gap-8">
      <div>
        ...
        <p className="mt-3 text-lg px-4">
          A <strong>prefix expression </strong> (also called{" "}
          <strong> Polish Notation</strong>) is an arithmetic expression in
          which operator comes before the operands.
          <br />
          Example: AB+
        </p>
      </div>
